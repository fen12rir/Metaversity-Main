...
export const loader = async ({ request }) => {
  ...
  return json({ user, activities, stats: { totalUsers, totalActivities, upcomingActivities } });
};

export default function AdminDashboard() {
  const { user, activities, stats } = useLoaderData();
    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-red-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Manage activities and monitor community engagement</p>
        </div>
        ...
        <div className="mb-6">
          <Link
            ...
            className="inline-flex items-center px-6 py-3 bg-indigo-600 text-white font-semibold rounded-lg hover:bg-indigo-700 shadow-lg hover:shadow-xl transition-all duration-200"
          >
